...
const BrandsStrip = () => {
    ...
    return (
        ...
        <Box sx={{backgroundColor:"#FAFAFA"}}>
            <Marquee style={style}>
                <img src={faBrands1} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands2} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands3} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands4} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands5} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands6} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands1} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands2} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands3} alt="loading" style={{ padding: "0 25px" }} />
                <img src={faBrands4} alt="loading" style={{ padding: "0 25px" }} />
